        ...
        <div className="lp2-left-inner">
          ...
          <div className="lp2-headline">
            <h1 className="lp2-title">
              Simplifiez votre<br />
              <span className="lp2-title-accent">gestion RH</span>
            </h1>
            <p className="lp2-desc">
              Une plateforme complete et securisee pour gerer vos employes,
              conges, documents et taches au quotidien.
            </p>
          </div>
          ...
          {/* Back to home */}
          <Link to="/" className="lp2-back-link">
      ...
      <div className="lp2-right">
        <div className="lp2-card">
          ...
          <div className="lp2-card-header">
            ...
            <h2 className="lp2-card-title">Connexion</h2>
            <p className="lp2-card-subtitle">Bienvenue ! Connectez-vous a votre espace.</p>
          </div>
          ...
          {/* Form */}
          <form className="lp2-form" onSubmit={handleLogin}>
            ...
            {/* Quick login buttons */}
            <div className="lp2-quick-login">
              <p className="lp2-quick-login-label">Comptes de test :</p>
              <div className="lp2-quick-login-buttons">
                <button
                  type="button"
                  className="lp2-quick-btn lp2-quick-btn-director"
                ...
                <button
                  type="button"
                  className="lp2-quick-btn lp2-quick-btn-employee"
                  onClick={() => handleQuickLogin('sarah@test.com', '123456789')}
                >
                  👤 Employé
                </button>
              </div>
